#!/usr/bin/env python
#SBATCH --job-name=MPAS_preprocessing
#SBATCH --output=logs/MPAS_preprocessing-%j.out
...
ptools.preprocess_MPAS(infiles[ID], tempfiles[ID], outfiles[ID], options_selvar[ID], **config)