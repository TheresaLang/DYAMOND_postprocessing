#!/usr/bin/env python
#SBATCH --job-name=w_calc
#SBATCH --output=logs/w_calc-%j.out
...
# Script to calculate vertical velocity w from pressure velocity omega
# (requires specific humidity, temperature and pressure)
# separately for every timestep contained in the (IFS) input file.
...
models, runs, omega_files, temp_files, qv_files, pres_files, height_files = filelists.get_wcalculation_filelist(**config)
