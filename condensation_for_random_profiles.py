#!/usr/bin/env python
#SBATCH --job-name=condensation_estimation
#SBATCH --output=logs/condensation_estimation-%j.out
...
ptools.estimate_condensation_for_random_profiles(models[ID], runs[ID], **config)